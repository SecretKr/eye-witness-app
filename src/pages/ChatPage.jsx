...
//         answer:
//             "If you feel unsafe right now, **press the main Panic Button** immediately. This will help you quickly find and route to the nearest **Safe Haven** location where you can get immediate help.",
//     },
//     {
//         question: "What to do after an incident?",
//         answer:
//             "1. Make sure you are in a secure location, like a Safe Haven.\n2. **Log the incident** using our Incident Form (including perpetrator details).\n3. Keep any evidence safely stored.\n4. If needed, you can explore legal options through our app.",
//     },
//     {
//         question: "How do I contact a lawyer?",
//         answer:
//             "Go to the **Incidents Page** and check the **'Partnered Lawyers'** section. There, you can discover trustworthy legal professionals who specialize in harassment cases and reach out to them for advice.",
//     },
// ];

export const PRESET_QUESTIONS = [
    {
        question: "ฉันกำลังถูกคุกคาม ฉันควรทำอย่างไร?",
        answer: "หากคุณรู้สึกไม่ปลอดภัยในขณะนี้ โปรดกดปุ่มฉุกเฉิน (Panic Button) ทันที ระบบจะช่วยคุณค้นหาและนำทางไปยัง พื้นที่ปลอดภัย (Safe Haven) ที่ใกล้ที่สุดเพื่อรับความช่วยเหลือโดยด่วน"
    },
    {
        question: "ควรทำอย่างไรหลังจากเกิดเหตุการณ์?",
        answer: "1. ตรวจสอบให้แน่ใจว่าคุณอยู่ในสถานที่ที่ปลอดภัย เช่น Safe Haven\n2. บันทึกเหตุการณ์ โดยใช้แบบฟอร์มรายงานเหตุการณ์ของเรา (รวมถึงรายละเอียดของผู้กระทำผิด)\n3. เก็บรักษาหลักฐานต่าง ๆ ไว้อย่างปลอดภัย\n4. หากจำเป็น คุณสามารถศึกษากระบวนการทางกฎหมายเพิ่มเติมได้ผ่านแอปของเรา"
    },
    {
        question: "ฉันจะติดต่อทนายความได้อย่างไร?",
        answer: "ไปที่ หน้าเหตุการณ์ (Incidents Page) และตรวจสอบที่ส่วน 'ทนายความพันธมิตร' (Partnered Lawyers) ในส่วนนั้นคุณจะพบกับผู้เชี่ยวชาญด้านกฎหมายที่น่าเชื่อถือซึ่งเชี่ยวชาญด้านคดีคุกคามโดยเฉพาะ และสามารถติดต่อเพื่อขอคำปรึกษาได้"
    }
];
        ...
        return [
            {
                id: "welcome",
                role: "assistant",
                text: "Hello! I'm your **Legal Assistant**. Ask me about personal safety, emergency situations, gathering evidence, or reporting incidents.\n\nสวัสดีครับ! ผมคือผู้ช่วยด้านกฎหมายของคุณ คุณสามารถสอบถามผมได้เกี่ยวกับความปลอดภัยส่วนบุคคล, สถานการณ์ฉุกเฉิน, การเก็บรวบรวมหลักฐาน หรือการรายงานเหตุการณ์ต่างๆ ครับ",
                done: true,
            },
        ];
    });
...
Based on this information, what immediate legal advice or next steps would you suggest? Keep it concise and practical. Answer in Thai`;
            ...
            const triggerAutoChat = async () => {
                ...
                await streamChatResponse(
                    ...
                    () => {
                        setMessages((prev) =>
                            prev.map((msg) =>
                                msg.id === tempAssistantId ? { ...msg, done: true } : msg,
                            ),
                        );
                        setIsStreaming(false);
                    },
        ...
        <div className="flex flex-col h-full overflow-hidden">
            ...
            <header className="shrink-0 px-4 mt-4 mb-3 animate-fade-in-up flex items-center justify-between">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h1 className="text-3xl font-bold text-white tracking-wide leading-none">
                            LEGAL CHAT
                        </h1>
