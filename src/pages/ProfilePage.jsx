...
const ProfilePage = () => {
  ...
  return (
    <div className="min-h-screen pb-24 px-6 pt-safe-top relative overflow-hidden bg-black">
      ...
      <div className="absolute top-0 left-0 w-full h-96 blur-[100px] pointer-events-none rounded-full -translate-y-1/2"></div>
      ...
      {/* Title */}
      <h1 className="text-center text-4xl font-medium text-white tracking-widest mb-28 drop-shadow-md animate-fade-in-up [animation-delay:100ms] opacity-0 [animation-fill-mode:forwards]">
        PROFILE
      </h1>
      ...
      <div className="relative mb-6 animate-fade-in-up [animation-delay:200ms] opacity-0 [animation-fill-mode:forwards]">
        ...
        {/* Card Content */}
        <div className="bg-primary-gradient from-slate-600/80 to-slate-800/90 backdrop-blur-md rounded-2xl pt-24 pb-6 px-6 shadow-2xl relative overflow-hidden border border-white/10">
          ...
          <div className="grid grid-cols-2 gap-y-5 text-white relative z-10 w-full mt-2">
            ...
            <div className="col-span-1 flex items-center gap-3">
              ...
              <span className="font-medium text-[13px] text-white/90 tracking-widest">
                11XXXXXXXXXXX
              </span>
            </div>
...
const MenuOption = ({ label, isDestructive = false }) => (
  <div className="group flex items-center justify-between py-4 border-b border-white/10 cursor-pointer active:bg-white/5 transition-colors">
    <span
      className={`text-sm font-medium ${isDestructive ? "text-red-500" : "text-white"}`}
    >
      {label}
    </span>
    <ChevronRight
